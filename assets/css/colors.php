...
// Set default color.
if ( ! $color || ! check_hex_color( $color ) ) {
	$color = '#3498db';
}
...
.dark .entry-terms.post_tag a:hover,
.dark .entry-terms.category a:hover,
...
.dark .fbox-effect.fbox-dark .fbox-icon i:after {
	box-shadow: 0 0 0 2px <?php echo $color; ?>;
}
